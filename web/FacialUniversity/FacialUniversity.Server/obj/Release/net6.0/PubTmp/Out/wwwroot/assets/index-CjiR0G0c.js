...
function ta(e) {
  ...
  function S(f, a, d, v) {
    ...
    for (
      var x = (E = null), _ = a, N = (a = 0), H = null, T = d.next();
      _ !== null && !T.done;
      N++, T = d.next()
    ) {
      _.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
...
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), Na(n, t, r), xo(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
  ...
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = xu + 500 - Q()), 10 < n))
          ) {
            if (jr(e, 0) !== 0) break;
...
function wd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - xu)
        ? Cn(e, 0)
        : (Cu |= t)),
    pe(e, n);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, Q()), !(R & 6) && ((lt = Q() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = _u;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, _u] },
  yt = {
...
function Rd() {
  ...
  return V.jsxs("div", {
    children: [
      V.jsxs("nav", {
        children: [
          ...
          V.jsxs("ul", {
            ...
            children: [
              V.jsx("li", {
                children: V.jsx("a", { href: "#inicio", children: "INÍCIO" }),
              }),
              V.jsx("li", {
                children: V.jsx("a", { href: "#acesso", children: "ACESSO" }),
              }),
              V.jsx("li", {
                children: V.jsx("a", { href: "#planos", children: "PLANOS" }),
              }),
              V.jsx("li", {
                children: V.jsx("a", { href: "#suporte", children: "SUPORTE" }),
              }),
              V.jsx("li", {
                children: V.jsx("a", { href: "#sobre", children: "SOBRE NÓS" }),
              }),
            ],
          }),
        ],
      ...
      V.jsxs("div", {
        ...
        id: "inicio",
        children: [
          V.jsx("h1", { children: "FACIAL UNIVERSITY" }),
          V.jsx("p", {
            children:
              "Somos uma empresa dedicada à inovação e eficiência, oferecendo soluções avançadas para o controle de presença e acesso em universidades. Exploramos métodos de controle de acesso, focando no desenvolvimento de um dispositivo biométrico facial para controle de presença em universidades.",
          }),
          V.jsxs("div", {
            className: "buttons",
            children: [
              V.jsx("button", {
                className: "btn",
                children: "Solicitar Teste",
              }),
              V.jsx("button", { className: "btn", children: "Assinar" }),
            ],
          }),
        ],
      }),
  ...
  async function o() {
    try {
      const i = await (await fetch("weatherforecast")).json();
      n(i);
    } catch (u) {
      console.error("Error fetching weather data:", u);
    }
  }
}
Ql.createRoot(document.getElementById("root")).render(
  V.jsx(gc.StrictMode, { children: V.jsx(Rd, {}) })
);
